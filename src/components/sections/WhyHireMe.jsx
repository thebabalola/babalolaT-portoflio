          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pt-12 pb-4">
            ...
            <div className="group cursor-pointer p-6 bg-dark-accent/50 rounded-lg text-center glass-effect border border-transparent hover:border-primary-green transition-all relative overflow-hidden hover:shadow-glow hover:-translate-y-2 duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-semibold text-light-grey mb-2 group-hover:text-white transition-colors duration-300">Eager Learner</h3>
                <p className="text-light-grey group-hover:text-white/90 transition-colors duration-300">Passionate about embracing new challenges to deliver innovative solutions.</p>
              </div>
            </div>
            ...
            <div className="group cursor-pointer p-6 bg-dark-accent/50 rounded-lg text-center glass-effect border border-transparent hover:border-primary-green transition-all relative overflow-hidden hover:shadow-glow hover:-translate-y-2 duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-semibold text-light-grey mb-2 group-hover:text-white transition-colors duration-300">Project Builder</h3>
                <p className="text-light-grey group-hover:text-white/90 transition-colors duration-300">Consistently deliver clean, user-focused solutions through hands-on development.</p>
              </div>
            </div>
            ...
            <div className="group cursor-pointer p-6 bg-dark-accent/50 rounded-lg text-center glass-effect border border-transparent hover:border-primary-green transition-all relative overflow-hidden hover:shadow-glow hover:-translate-y-2 duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-semibold text-light-grey mb-2 group-hover:text-white transition-colors duration-300">Team Player</h3>
                <p className="text-light-grey group-hover:text-white/90 transition-colors duration-300">Thrive in collaborative settings, contributing ideas to achieve shared goals.</p>
              </div>
            </div>
            ...
            <div className="group cursor-pointer p-6 bg-dark-accent/50 rounded-lg text-center glass-effect border border-transparent hover:border-primary-green transition-all relative overflow-hidden hover:shadow-glow hover:-translate-y-2 duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-semibold text-light-grey mb-2 group-hover:text-white transition-colors duration-300">Problem Solver</h3>
                <p className="text-light-grey group-hover:text-white/90 transition-colors duration-300">Driven to create innovative solutions for real-world challenges.</p>
              </div>
            </div>
